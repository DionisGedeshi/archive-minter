...
Archive-Minter is a minimal, offline-first web article archiver built for speed and simplicity. You get to keep your favorite articles, tutorials, and reads safe, readable, and accessible locally, forever; even without an internet connection.
...
### Windows
1. Download either the `.msi` or the `.exe` setup file.
...
3. **Important Note:** Because this is an indie open-source app, Apple's Gatekeeper will flag it as coming from an "unidentified developer." To open it for the first time:
   ...
   * **Right-click** the Archive-Minter app and select **Open**.
